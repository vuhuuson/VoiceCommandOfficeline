 ...
 *   hCybVAD(IN): The handle of VAD.
 *   lpsSample(IN): The audio buffer.
 *   nSampleCount(IN): The sample count of audio buffer.
 * Returns 0 if silence, 1 if voice start, 2 if voice still active, and 3 if voice end.
 */
