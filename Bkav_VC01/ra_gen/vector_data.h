...
typedef enum IRQn
{
    ...
    SCI0_RXI_IRQn = 12, /* SCI0 RXI (Receive data full) */
    SCI0_TXI_IRQn = 13, /* SCI0 TXI (Transmit data empty) */
    SCI0_TEI_IRQn = 14, /* SCI0 TEI (Transmit end) */
    SCI0_ERI_IRQn = 15, /* SCI0 ERI (Receive error) */
} IRQn_Type;
#endif /* VECTOR_DATA_H */
